  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx(PageHeader, {
        title: 'Saved Jobs',
        description:
          'Bookmarked opportunities ready for application preparation and resume tailoring.',
      ...
      _jsx('div', {
        ...
        children: sampleSavedJobs.map((job) =>
          _jsxs(
            Card,
            {
              className: 'space-y-4',
              children: [
                _jsxs('div', {
                  ...
                  children: [
                    ...
                    _jsxs(Badge, { variant: 'success', children: [job.matchScore, '% Match'] }),
                  ],
                }),
                _jsxs('div', {
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        ...
                        _jsxs(Button, {
                          ...
                          children: [
                            'Start Application ',
                            _jsx(ArrowRight, { className: 'h-3.5 w-3.5 ml-1' }),
                          ],
                        }),
                      ],
                    }),
