...
export function ApplicationsPage() {
  ...
  if (isLoading) return _jsx(LoadingState, { message: 'Loading applications from database...' });
  if (isError) return _jsx(ErrorState, { title: 'Failed to load applications', onRetry: refetch });
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsx(PageHeader, {
        ...
        description:
          'Monitor status lifecycle, timeline history, and follow-ups across your job applications.',
        breadcrumbs: [{ label: 'Home', href: '/' }, { label: 'Applications' }],
        actions: _jsxs(Button, {
          size: 'sm',
          onClick: () => setIsCreateModalOpen(true),
          children: [_jsx(Plus, { className: 'h-4 w-4 mr-1.5' }), ' Start New Application'],
        }),
      }),
      _jsxs(Card, {
        ...
        children: [
          ...
          _jsxs('span', {
            ...
            children: ['Showing ', applications.length, ' persistent application(s)'],
          }),
        ],
      }),
      applications.length > 0
            ...
            children: [
              _jsx(TableHeader, {
                children: _jsxs(TableRow, {
                  children: [
                    _jsx(TableHead, { children: 'Job Title & Company' }),
                    _jsx(TableHead, { children: 'Status' }),
                    _jsx(TableHead, { children: 'Last Activity' }),
                    _jsx(TableHead, { children: 'Timeline Events' }),
                  ...
                  _jsxs(
                    TableRow,
                    {
                      children: [
                          ...
                          children: _jsxs('div', {
                            children: [
                              _jsx('div', {
                                ...
                                children: app.job?.jobTitle || 'Job Listing',
                              }),
                              _jsxs('div', {
                        ...
                        _jsx(TableCell, {
                          className: 'text-xs text-slate-400',
                          children: formatDate(app.lastActivityDate || app.updatedAt),
                        }),
                        _jsx(TableCell, {
                          children: _jsxs(Button, {
                            ...
                            children: [
                              _jsx(History, { className: 'h-3.5 w-3.5 mr-1' }),
        ...
        : _jsx(EmptyState, {
            ...
            icon: _jsx(Briefcase, { className: 'h-6 w-6 text-slate-400' }),
            ...
            _jsxs('div', {
              ...
              children: [
                ...
                _jsx(Button, {
                  ...
                  children: 'Start Tracking Application',
                }),
              ],
            }),
          ],
        ...
        _jsx(Drawer, {
          ...
          children: _jsxs('div', {
            ...
            children: [
              _jsx('div', {
                className: 'space-y-3',
                children: (selectedApp.timelineEvents || []).map((ev, i) =>
                  _jsxs(
                    'div',
                    {
              ...
              _jsxs('form', {
                ...
                children: [
                  _jsx('h4', {
                    ...
                    children: 'Log Custom Timeline Event',
                  }),
                  _jsx(Input, {
